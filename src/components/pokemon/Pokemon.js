...
export default class Pokemon extends Component {
    ...
    async componentDidMount() {
        ...
        await axios.get(pokemonSpeciesUrl).then(res => {
            ...
            const catchRate = Math.round((100 / 225) * res.data['capture_rate']);
                ...
                <div className="card">
                        ...
                        <div className="row align-items-center">
                            ...
                            <div className="row mt-1">
                                <div className="col">
                                    ...
                                    <button type="button" class="btn btn-outline-primary" onClick={() => this.setState({showForm: true}) }>Catch</button>
                    ...
                    <hr/> 
                            ...
                            <div className="row">
                                ...
                                <div className ="col-md-6">
                                    <div className="row">
                                        ...
                                        <div className="col-md-6">
                                            <h6 className="float-right">Ablities: </h6>
                                        </div>
                                        <div className="col-md-6">
                        ...
                        <div className="card-footer text-muted">
                                Data From <a href='https://pokeapi.co/' target="_blank" className='card-link'>PokiAPI.co</a>
                        </div>
                </div>
            </div>
        )
